...
export class DiagramWidget extends React.Component {
    ...
    onMouseUp(event) {
        ...
        if (element === null) {
            ...
            // Add the node model to the sink
            ...
            action.selectionModels.forEach(model => {
                ...
                if (model.model instanceof PointModel) {
                    ...
                    if (element.model instanceof PortModel) {
                        ...
                        // Link was connected to a port, update the sink
    ...
    render() {
        const {diagramEngine, title, agenda} = this.props;
        ...
        return (
            ...
            >
                <NodeLayerWidget diagramEngine={diagramEngine} title={title} agenda={agenda}/>
